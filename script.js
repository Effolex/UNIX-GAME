		...
		var questions = ["lista arquivos e diretorios", 
			...
			"le o conteudo do arquivo chamado arq e exibe no terminal", "exibe um arquivo chamado arq, uma página por vez",
			...
			"corresponde a um ou mais caracteres","corresponde a um UNICO caracter", "le a pagina do manual online do comando help", "breve descrição do comando help" ];
